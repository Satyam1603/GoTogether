...
public interface RideRepository extends JpaRepository<Ride, Long> {
  ...
  //  List<Ride> findByPickupLocationContainingAndDropLocationContainingAndDepartureTimeBetween(String pickupKeyword, String dropKeyword,LocalDateTime start, LocalDateTime end);
}