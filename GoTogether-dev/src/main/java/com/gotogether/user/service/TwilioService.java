...
public class TwilioService {
    ...
    public void sendSMS(String to, String message) {
        try {
            ...
            e.printStackTrace();
            // Don't throw exception - SMS failure shouldn't block OTP generation
            // OTP is stored in Redis and can be verified even if SMS fails
        }
    }
    ...
    public void sendEmail(String to, String subject, String body) {
        ...
        System.out.println("DEBUG: Email object created for " + to);
        System.out.println("DEBUG: Using SendGrid API Key: " + (sendGridApiKey != null ? "Present" : "Missing"));
        System.out.println("DEBUG: From Email: " + fromEmail);
        System.out.println("DEBUG: To Email: " + to);
        System.out.println("DEBUG: Subject: " + subject);
        System.out.println("DEBUG: key: " + sendGridApiKey);
